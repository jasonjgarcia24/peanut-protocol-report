...
contract PeanutV3__REPAIRED is IERC721Receiver, IERC1155Receiver {
    struct deposit {
    ...
    function onERC721Received(
        ...
        uint256 _amount = 1;
        address _pubKey20 = abi.decode(abi.encode(_data), (address));
    ...
    function onERC1155Received(
        ...
        address _pubKey20;
        _pubKey20 = abi.decode(abi.encode(_data), (address));
    ...
    function onERC1155BatchReceived(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            ...
            _pubKey20 = abi.decode(abi.encode(_pubKey20Bytes), (address));
